...
//    messages
    ...
    echo '<div class="comment-wrap mb-30" style="margin-right:20%;margin-left:5%; "><div class="commment_title"><h3 class="title">Message</h3></div><ul class="comment-list" ';
        ...
        echo '<li>
            <div class="comment-box mb-30" >
                <div class="d-flex justify-content-between" style="width:100%">
                    ...
                    <div class="">
                    <h6 style="color:#fb7f61;" class="title">'.$mob.'</h6>
                    </div>
                </div>
